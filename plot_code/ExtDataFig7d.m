...
load('ExtDataFig7_HM_susE.mat');
%%
figure;
plotShadedErrorbar(HM_susE(mean(HM_susE(:,size(HM_susE,2)-5:size(HM_susE,2)-1),2)>0.5,1:size(HM_susE,2)-1),2.564,[31, 119, 180]/256,0.3);
...
legend({'','Sustained E','','Sustained I','','Transient I',''});
legend boxoff
xlim([0 26]);
